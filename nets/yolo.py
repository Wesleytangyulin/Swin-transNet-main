...
class YOLOPAFPN(nn.Module):
    def __init__(self, depth = 1.0, width = 1.0,
        ...
        self.embed_dim = swin_tiny_patch4_window7_224().embed_dim

        self.in_features    = in_features

        # mode有更改,有'nearest', 'linear', 'bilinear', 'bicubic' and trilinear
        self.upsample = nn.Upsample(scale_factor=2, mode='bilinear',align_corners=True) #TYL 加了align_corners=True
        # 注意力机制
